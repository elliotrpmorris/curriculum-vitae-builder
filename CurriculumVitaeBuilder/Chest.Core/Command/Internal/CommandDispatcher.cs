// <copyright file="CommandDispatcher.cs" company="BJSS">
...
namespace Chest.Core.Command.Internal
{
    ...
    internal class CommandDispatcher : ICommandDispatcher
    {
        ...
        public CommandDispatcher(ServiceLocator serviceLocator)
        {
            this.Resolve = serviceLocator;
        }

        private ServiceLocator Resolve { get; }
            ...
            where T : ICommand
        {
            ...
            await commandHandler.Handle(command, metadata);
        }

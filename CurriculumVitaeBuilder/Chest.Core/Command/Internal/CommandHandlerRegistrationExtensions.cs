// <copyright file="CommandHandlerRegistrationExtensions.cs" company="BJSS">
...
namespace Chest.Core.Command.Internal
{
    ...
    {
        /// <summary>
        /// Gets type information for all commands, handlers and validator in the
        /// given assemblies.
        /// </summary>
        /// <param name="assemblies">The assemblies to scan.</param>
        /// <returns>Type information on all command, handlers and validator.</returns>
        public static TypeRegistry GetHandlerDetails(
            this IEnumerable<Assembly> assemblies)
        {
            // get all the concrete types
            var types = assemblies
                .SelectMany(x => x.ConcreteTypes())
                .ToList();
            ...
            IEnumerable<Type> authProviders)
        {
            ...
            // return the details
            return new CommandHandlerDetail(handlerType, commandType, attr.Name, attr.Version, validator, authProvider);
        }
